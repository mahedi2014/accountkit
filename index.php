...
if (isset($_POST["code"])) {
    ...
    $ch = curl_init();
    // Set url elements
    $fb_app_id = '230992427033392'; //app id
    $ak_secret = 'bde265ff15d9006287d3ce8182e59ec3'; //accountkit secret
    $ak_token = 'AA';
    $token = $ak_token.'|' . $fb_app_id . '|' . $ak_secret;
    // Get access token
...
<script>
    AccountKit_OnInteractive = function () {
        AccountKit.init(
            {
                appId: '230992427033392', //app id
                app_secret: 'fa32e9cde16359954936019ffa381968', //app secrete code
                state: "abcd",
                version: "v1.0"
            }
        );
